...
function loginAgainIfDifferentShop(routes, accessMode, Shopify) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        query = ctx.query;
                        return [4 /*yield*/, Shopify.Utils.loadCurrentSession(ctx.req, ctx.res, accessMode === 'online')];
                    case 1:
                        session = _a.sent();
                        if (!(session && query.shop && session.shop !== query.shop)) return [3 /*break*/, 3];
                        return [4 /*yield*/, utilities_1.clearSession(ctx, accessMode, Shopify)];
                    case 2:
                        _a.sent();
