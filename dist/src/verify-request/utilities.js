...
function clearSession(ctx, accessMode, Shopify) {
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, Shopify.Utils.deleteCurrentSession(ctx.req, ctx.res, accessMode === 'online')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
                    error_1 = _a.sent();
                    if (error_1 instanceof Shopify.Errors.SessionNotFound) {
