...
function verifyRequest(givenOptions, Shopify) {
    ...
    return koa_compose_1.default([
        login_again_if_different_shop_1.loginAgainIfDifferentShop(routes, accessMode, Shopify),
        verify_token_1.verifyToken(routes, accessMode, returnHeader, Shopify),
    ]);
}
