...
function createShopifyAuth(options, Shopify) {
    ...
    var topLevelOAuthRedirect = create_top_level_oauth_redirect_1.default(Shopify.Context.API_KEY, inlineOAuthPath);
    var enableCookiesPath = oAuthStartPath + "/enable_cookies";
    var enableCookies = create_enable_cookies_1.default(config, Shopify);
    var requestStorageAccess = create_request_storage_access_1.default(config, Shopify);
    set_user_agent_1.default(Shopify);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, Shopify.Auth.beginAuth(ctx.req, ctx.res, shop, oAuthCallbackPath, config.accessMode === 'online')];
                    case 3:
                        redirectUrl = _b.sent();
                    ...
                    case 7:
                        ...
                        _a = ctx.state;
                        return [4 /*yield*/, Shopify.Auth.validateAuthCallback(ctx.req, ctx.res, authQuery)];
                    case 8:
                        _a.shopify = _b.sent();
                    ...
                    case 11:
                        e_1 = _b.sent();
                        switch (true) {
                            case e_1 instanceof Shopify.Errors.InvalidOAuthError:
                                ctx.throw(400, e_1.message);
                                break;
                            case e_1 instanceof Shopify.Errors.CookieNotFound:
                            case e_1 instanceof Shopify.Errors.SessionNotFound:
