...
function createShopifyAuth(options, Shopify) {
  ...
  var topLevelOAuthRedirect = create_top_level_oauth_redirect_1.default(
  ...
  var requestStorageAccess = create_request_storage_access_1.default(
    config,
    Shopify,
  );
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 7:
            ...
            return [
              4 /*yield*/,
              Shopify.Auth.validateAuthCallback(ctx.req, ctx.res, authQuery),
            ];
          case 8:
            _a.shopify = _b.sent();
