...
function setUserAgent(Shopify) {
    ...
    else if (!Shopify.Context.USER_AGENT_PREFIX.includes(exports.KOA_USER_AGENT_PREFIX)) {
        Shopify.Context.USER_AGENT_PREFIX = Shopify.Context.USER_AGENT_PREFIX + " | " + exports.KOA_USER_AGENT_PREFIX;
    }
}
